...
ERROR_MESSAGE = "Oops! An exception occurred! \n\n**Error** : {} " \
            "\n\nPlease visit @MAMBA)X)SUPPORT If This Message Doesn't Contain Any " \
...
async def generate_session(bot, msg, telethon=False):
    ...
    text = "**{} STRING SESSION** \n\n`{}` \n\nGenerated by @MAMBA_X_SUPPORT".format("TELETHON" if telethon else "PYROGRAM", string_session)
    await client.send_message("me", text)
    await client.disconnect()
    await phone_code_msg.reply("Successfully Generated {} String Session. \n\nPlease Check Your Saved Messages! \n\nBy @MAMBA_X_SUPPORT".format("telethon" if telethon else "pyrogram"))
